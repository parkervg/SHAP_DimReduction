...
class Blogger:
    def __init__(self, display_caller=False):
        self.display_caller = (
            display_caller  # Whether to log caller function for easier debugging
        )

    @staticmethod
    def _get_fmt_caller():
        (filename, line_number, caller_name, lines, index) = inspect.getframeinfo(
            inspect.currentframe().f_back.f_back
        )  # Back two steps - from _fmt_caller and the log function
